module.exports = (client) => {
  ...
  app.use(
    session({
      ...
      store: MongoStore.create({
        mongoUrl: "mongodb+srv://delidiscord:baran2323@cluster0.g5hcg.mongodb.net/carmendataas?retryWrites=true&w=majority",
      }),
    })
  );
  ...
  const CLIENT_ID = client.user.id,
    ...
    CLIENT_CALLBACK_URL = "https://helper-cats.com/api/auth/discord/redirect";
